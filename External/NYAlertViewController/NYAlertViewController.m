...
- (void)commonInit {
	UIColor *defaultTitleColor = [UIColor colorWithRed:0.0 green:122.0/255.0 blue:1.0 alpha:1.0];
	UIColor *defaultButtonColor = [UIColor colorWithWhite:0.97f alpha:1.0f];
	...
	_destructiveButtonColor = defaultButtonColor;
	_disabledButtonColor = defaultButtonColor;

	_buttonTitleColor = defaultTitleColor;
	_cancelButtonTitleColor = defaultTitleColor;
