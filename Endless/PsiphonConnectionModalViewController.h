...
@interface PsiphonConnectionSplashViewController : PsiphonConnectionModalViewController
@end

@interface PsiphonConnectionAlertViewController : PsiphonConnectionModalViewController
@end
